...
// TriggerPriceType represents the price type for conditional orders
type TriggerPriceType string

const (
	TriggerPriceType_LAST_PRICE TriggerPriceType = "LAST_PRICE" // Use last traded price (default)
	TriggerPriceType_MARK_PRICE TriggerPriceType = "MARK_PRICE" // Use mark price
)
...
type CreateOrderParams struct {
	...
	ExtraDataJson string `json:"extraDataJson,omitempty"` // Extra data in JSON format
}
